...
inputdog_add_input("slowmo",  ord("X"),   gp_shoulderrb);

inputdog_add_input("left2",   ord("A"),    inputdog_gp_left_stick_left);
inputdog_add_input("right2",  ord("D"),   inputdog_gp_left_stick_right);
inputdog_add_input("up2",     ord("W"),      inputdog_gp_left_stick_up);
inputdog_add_input("down2",   ord("S"),    inputdog_gp_left_stick_down);
