...
DrawUIMenuText(x, y - 240, deathText, fntMenuSmallSuper, c_red, 1, true, 4, c_white);
...
+ " x 50", fntMenuSmall, c_black, 1, true, 2, c_white);
...
DrawUIMenuTextTop(x - 580, y - 160, LLHighscoresTopFormatted(), fntMenuSmallSuper, c_black, 1, true, 1, c_white);

DrawUIMenuText(x + 580, y - 192, "CURRENT RANK", fntMenuSmall, c_black, 1, true, 4, c_white);
DrawUIMenuTextTop(x + 580, y - 160, LLHighscoresCenteredFormatted(), fntMenuSmallSuper, c_black, 1, true, 1, c_white);